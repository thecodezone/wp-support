...
class AssetTest extends TestCase
{
    ...
    public function it_filters() {
        ...
        $asset_queue = $this->getContainer()->get( AssetQueueInterface::class );
        $asset_queue->filter( [ 'script1' ], [ 'style1' ] );
    ...
    public function it_allows_vite() {
        ...
        $style2 = new \stdClass();
        $style2->handle = 'style2';
        $vite_client1 = new \stdClass();
        $vite_client1->handle = 'vite-client-1';
        $wp_styles->registered = [ 'style1' => $style1, 'style2' => $style2, 'vite-client-1' => $vite_client1 ];
        // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited
        $wp_scripts = new \stdClass();
        ...
        $vite_client1 = new \stdClass();
        $vite_client1->handle = 'vite-client-1';
        $wp_scripts->registered = [ 'script1' => $script1, 'script2' => $script2, 'vite-client-1' => $vite_client1 ];
